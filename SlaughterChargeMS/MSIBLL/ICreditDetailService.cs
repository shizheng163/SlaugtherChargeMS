...
namespace MSIBLL
{
    public partial interface ICreditDetailService : IBaseService<DB_CreditDetail>
    {
        void Add(DB_CreditDetail model, out string retMsg);

        void Update(DB_CreditDetail model, out string retMsg);

        void Delete(List<int> list, out string retMsg);
        DB_CreditDetail GetModel(int Id);
